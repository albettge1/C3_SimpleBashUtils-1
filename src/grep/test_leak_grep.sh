...
declare -a extra=(
"-n for tesst.txt test2.txt"
"-n for tesst.txt"
"-n -e ^\} tesst.txt"
"-c -e /\ tesst.txt"
"-ce ^int tesst.txt test2.txt"
"-e ^int tesst.txt"
"-nivh = tesst.txt test2.txt"
"-e"
"-ie INT tesst.txt"
"-echar tesst.txt test2.txt"
"-ne = -e out tesst.txt"
"-iv int tesst.txt"
"-in int tesst.txt"
"-c -l test tesst.txt test2.txt"
"-v tesst.txt -e ank"
"-noe ) tesst.txt"
"-l for tesst.txt test2.txt"
"-o -e test tesst.txt"
"-e = -e out tesst.txt"
"-noe test -e can -e we -e are -e the tesst.txt"
"-e test -e can -e we -e are -e so tesst.txt"
"-c -e . tesst.txt -e '.'"
"-l for no_file.txt tesst.txt"
"-f tesst.txt test2.txt"
)
